    ...
    angular.module('FileManagerApp').factory('item', ['fileManagerConfig', 'chmod', function(fileManagerConfig, Chmod) {
        ...
        var Item = function(model, path) {
            var rawModel = {
                ...
                sharedFolder : model && model.sharedFolder || false,
                shareright:model && model.shareright || 'rw',
                issharedFolder:model && model.issharedFolder || false,
                isrecievedfolder:model && model.isrecievedfolder || false,
                ismountedfolder:model && model.ismountedfolder || false,
                sharableFolder:model && model.sharableFolder || true,
